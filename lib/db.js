...
async function sb(table, { method = "GET", body, query = "", headers: extra = {} } = {}) {
  ...
  const res = await fetch(url, {
    method,
    headers: { api key: SUPABASE_KEY, Authorization: "Bearer " + SUPABASE_KEY, "Content-Type": "application/json", Prefer: method === "POST" ? "return=representation" : method === "PATCH" ? "return=representation" : "", ...extra },
